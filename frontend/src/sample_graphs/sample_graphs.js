export const Samples = {
    ...
    MST: {
        ...
        edges: [
            ...
            { data: { id: "4-3", source: "4", target: "3", weight: 4 } },
    ...
    DAG: {
        ...
        edges: [
            ...
            { data: { id: "5-2", source: "5", target: "2", weight: 1 } },
            { data: { id: "3-6", source: "3", target: "6", weight: 1 } },
            { data: { id: "4-6", source: "4", target: "6", weight: 1 } },
    ...
    SCC: {
        ...
        edges: [
            ...
            { data: { id: "4-2", source: "4", target: "2", weight: 2 } },

            { data: { id: "4-9", source: "4", target: "9", weight: 4 } },
            { data: { id: "9-4", source: "9", target: "4", weight: 5 } },
            
            { data: { id: "5-4", source: "5", target: "4", weight: 1 } },
            { data: { id: "5-2", source: "5", target: "2", weight: 1 } },

            { data: { id: "5-6", source: "5", target: "6", weight: 6 } },
            { data: { id: "6-5", source: "6", target: "5", weight: 8 } },
            { data: { id: "7-5", source: "7", target: "5", weight: 2 } },
            { data: { id: "8-6", source: "8", target: "6", weight: 3 } },

            { data: { id: "7-8", source: "7", target: "8", weight: 6 } },

            { data: { id: "10-7", source: "10", target: "7", weight: 2 } },
            { data: { id: "8-10", source: "8", target: "10", weight: 2 } },

            { data: { id: "10-9", source: "10", target: "9", weight: 2 } },
            { data: { id: "10-11", source: "10", target: "11", weight: 2 } },
            { data: { id: "11-3", source: "11", target: "3", weight: 2 } },
        ],
    },
