...
//                 if(!el.data?.source || !el.data?.source) {
...
//             const warning = prompt("You can use max of 30 nodes");
//             if(nodeCount.current == 30) return warning;
...
//     }, [mode, setElements, directed]);


//     return (
//         <div style={{ height: "100%" }}>

//             <SandboxToolbar setMode = {setMode} onClear={() => {setElements([]); nodeCount(0)}} onLoad={() => setShowLoad(true)} setDirected={setDirected} directed={directed}/>
