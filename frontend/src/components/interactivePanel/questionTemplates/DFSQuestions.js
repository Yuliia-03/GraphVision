export const dfsQuestionTemplates = [
    {
        ...
        text: "After processing node {node}, what will the stack look like next? \n\n(bottom → top)",
    ...
    },
    {
        id: 2,
        type: "discover_nodes",
        text: "When processing node {node}, which neighbors will be discovered and pushed onto the stack?",
    ...
    },
    {
        id: 5,
        type: "visited_set",
        text: "After processing node {node}, which nodes are in the visited set?",
